...
`charly check box ghcr.io/opencharly/ubuntu-coder:latest` — **142 passed · 0 failed · 1 skipped** (fastfetch, by design).
...
charly check box ghcr.io/opencharly/ubuntu-coder:latest
