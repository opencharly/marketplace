...
name: shell
description: |-
  `charly shell`, interactive shells, command execution in containers, workspace mounts, TTY allocation, or port relay.
---
