...
arch:
  vm:
    source:
      ...
      # distro:                                    # OPTIONAL for arch/fedora only —
                                                    # inferred from base_user. REQUIRED
                                                    # for debian/ubuntu (else the wrong
                                                    # ssh package and unit are chosen)
                                                    # and for a non-`alpine`-named
