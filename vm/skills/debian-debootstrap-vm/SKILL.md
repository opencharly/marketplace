...
description: |
  ...
  disposable check-debian-debootstrap-vm deploy. Lives in the opencharly/distro-debian submodule.
...
test bed live in the **`opencharly/distro-debian`** repo (git submodule at
...
`charly --repo opencharly/distro-debian …`).
