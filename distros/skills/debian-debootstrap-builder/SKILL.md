...
description: |-
  ...
  opencharly/distro-debian submodule (box/debian).
...
`/charly-vm:debian-debootstrap-vm` bootstrap VM.

> **Lives in `opencharly/distro-debian`** (git submodule at `box/debian`). Build:
