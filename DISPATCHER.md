...
| the `jetkvm:` check verb / driving a JetKVM IP-KVM from a candy/box plan (out-of-process plugin; status, screenshot, keyboard/mouse, power, virtual media, USB, device config) | `/charly-check:jetkvm` |
